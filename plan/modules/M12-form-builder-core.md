...
| | |
|---|---|
| **Status** | IN PROGRESS — the merged localStorage-backed **STACK-DEMO** builder lacks snapshot persistence/compiler integration, server queries, structural locking, and full AC. See [`../status.md`](../status.md). |
