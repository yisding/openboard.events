...
8. Confirm the un-disabled "New event" button on M11's events list correctly routes into this
   wizard rather than the old disabled state. No `e2e/**` spec covers any of this yet.
