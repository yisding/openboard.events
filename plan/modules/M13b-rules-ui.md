...
| | |
|---|---|
| **Status** | IN PROGRESS — the merged **STACK-DEMO** conditional editor lacks complete visibility/routing UI, frozen evaluator integration, persistence, and AC. See [`../status.md`](../status.md). |
