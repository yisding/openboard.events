...
AM: architect lands M03 migrations on sb-dev/sb-test/sb-prod + M04 (incl. compiler) + M05a + M06a + seed orchestrator; deferred spikes (revalidate-60, aws4fetch PUT, PGlite compat, embed headers) run in parallel; WS-F: M08 + M34 start; WS-D: M07; WS-B1: M11-server; WS-E: finish M29 frozen-contract reconciliation + property/acceptance suite, then unblock M28 conflict wiring (independent CRUD scaffolding may start earlier); WS-C: M17 against seed.
