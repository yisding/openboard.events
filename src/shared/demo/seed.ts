import type { DemoState, SpeakerRecord, SubmissionRecord } from "./types";
...
const submissionSeed: Array<[string, string, string, string, string, string, number | null, number]> = [
  ["sub_101", "SESS-101", "spk_nadia", "From Prototype to Production: Evaluating Agentic Systems", "AI Agents", "Talk · 30 min", 4.8, 5],
  ["sub_102", "SESS-102", "spk_alex", "The New AI Engineer Stack", "Developer Tools", "Keynote · 45 min", 4.7, 5],
  ["sub_103", "SESS-103", "spk_priya", "Serving a Billion Tokens Before Lunch", "Infrastructure", "Talk · 30 min", 4.5, 4],
  ["sub_104", "SESS-104", "spk_marcus", "Interfaces for Autonomous Software", "Developer Tools", "Talk · 30 min", 3.9, 3],
  ["sub_105", "SESS-105", "spk_elena", "Small Models, Serious Capability", "Models & Research", "Talk · 30 min", 4.6, 4],
  ["sub_106", "SESS-106", "spk_jamal", "Red Teaming Agents in the Wild", "Safety", "Workshop · 60 min", 4.4, 4],
  ["sub_107", "SESS-107", "spk_sophia", "Designing AI Products People Trust", "Product", "Talk · 30 min", 4.2, 3],
  ["sub_108", "SESS-108", "spk_luis", "The 50ms Inference Stack", "Infrastructure", "Talk · 30 min", 4.1, 4],
  ["sub_109", "SESS-109", "spk_mina", "Memory Is the New Context Window", "Models & Research", "Talk · 30 min", null, 0],
  ["sub_110", "SESS-110", "spk_theo", "The Shape of Human–AI Collaboration", "Design", "Talk · 30 min", 4.7, 5],
  ["sub_111", "SESS-111", "spk_aisha", "AI That Discovers New Medicines", "Applied AI", "Talk · 30 min", 4.3, 4],
  ["sub_112", "SESS-112", "spk_owen", "A Protocol for Multi-Agent Teams", "AI Agents", "Talk · 30 min", 3.7, 2],
];

const submissions: SubmissionRecord[] = submissionSeed.map(([id, code, speakerId, title, track, format, score, reviewCount], index) => ({
  ...
  answers: { title, abstract: "A practical, candid session grounded in lessons from production.", track, experience: index % 3 === 0 ? "Advanced" : "Intermediate", recording: true }, score, reviewCount,
}));
...
export const initialDemoState: DemoState = {
  ...
  reviews: [
    { id: "rev_1", submissionId: "sub_101", reviewer: "Morgan Lee", score: 5, note: "Strong, specific, and deeply useful. Great fit for the audience.", createdAt: "2026-07-10T12:00:00.000Z" },
    { id: "rev_2", submissionId: "sub_101", reviewer: "Jamie Patel", score: 5, note: "Excellent speaker and a very timely subject.", createdAt: "2026-07-12T12:00:00.000Z" },
    { id: "rev_3", submissionId: "sub_101", reviewer: "Taylor Reed", score: 4, note: "Would like a little more about failure modes, otherwise strong.", createdAt: "2026-07-15T12:00:00.000Z" },
  ],
  resources: [
