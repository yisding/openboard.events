...
import type { CalendarCancellationSnapshotStored, CalendarEventSnapshotStored } from "@/shared/contracts";
...
export const calendarInvites = pgTable("calendar_invites", {
  ...
  eventSnapshot: jsonb("event_snapshot").$type<CalendarEventSnapshotStored>().notNull(),
...
export const calendarCancellationJobs = pgTable("calendar_cancellation_jobs", {
  ...
  snapshot: jsonb("snapshot").$type<CalendarCancellationSnapshotStored>().notNull(),
