...
import { listLog, listReminderRules, listTemplates } from "@/features/comms";
...
const TABS: readonly CommsTab[] = ["templates", "reminders", "log"];
...
export default async function Page({
  ...
  const [event, templates, reminderRules, log] = await Promise.all([
