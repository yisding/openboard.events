 ...
 */
export function AdminShell({ eventId, role, event: serverEvent, counts, user, canCreateEvent, nowIso = new Date().toISOString(), children }: { eventId: EventId; role: MemberRole; event?: AdminShellEvent; counts?: AdminShellCounts; user?: { name: string; email: string }; canCreateEvent: boolean; nowIso?: string; children: React.ReactNode }) {
