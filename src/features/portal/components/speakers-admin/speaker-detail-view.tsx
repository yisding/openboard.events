  ...
  return (
    <div className="page">
      ...
      <section className="panel" style={{ borderColor: "var(--red-border)" }}>
        <header className="panel-header"><div><h2>Erase this speaker</h2><p>Permanently delete {contact.name}’s personal data for this event to satisfy a right-to-erasure request.</p></div></header>
        <div className="drawer-content">
          <p className="long-copy">
            This deletes {contact.name}’s profile, submission participation, tasks, uploads and messages for this event, and anonymizes their name where it lingers on other records. If you administer {contact.name}’s organization, it also permanently deletes their organization CRM profile. It cannot be undone.
          </p>
