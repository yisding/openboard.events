 ...
 * to `true` the hour its module merges to `main` and the steps it gates start
 * running — that is the whole ceremony. Nothing else in the suite hard-codes a
 * module name, so this table is the single place the schedule can go stale.
 */
