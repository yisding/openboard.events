...
Eighteen manual test plans. They are weighted deliberately: **the core flow — solicit speakers,
...
## MTP-18 — The demo event and the guided tour
...
| **MTP-18** | **II** | **demo provisioning, the guided tour, and the mail/billing/index rails** | **medium** |
